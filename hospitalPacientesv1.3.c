...
int main(){
	...
	int  i=0, registro=0, encontrado, controlCiclo, validaNumero, selec1, selec2, selec3;
			...
			switch (selec2) {
				...
				case 1: //registro
					...
					if(registro>9){
						...
						//nueva instruccion para edad inicio
						do {
							controlCiclo=0;
							printf("\tEdad: ");
						...
						//nueva instruccion para edad fin
						
						//Nueva para sexo solo ingresa m/f---inicio---
						do {													
							controlCiclo=0;
							printf("\tSexo (m/f): ");
							fflush(stdin); //limpia buffer del teclado	
							...
							if (validaSexo=='m' || validaSexo=='f') {
								...
								printf("\t- Error! solo m/f -\n");
							}
						} while (controlCiclo==0);
						//Nueva para sexo solo ingresa m/f---fin---
						...
						//-----OK-----Valida que solo se ingresen numeros-----inicio -----
						do {													
							controlCiclo=0;
							printf("\tCondicion del paciente, ingrese un numero\n");
							printf("\t1=Muy Leve 2=Leve 3=Grave 4=Muy grave 5=En extremo grave: ");
						...
						//-----Valida que solo se ingrese numeros -----fin -----
